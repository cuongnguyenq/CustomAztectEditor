...
open class AztecText : AppCompatEditText, TextWatcher, UnknownHtmlSpan.OnUnknownHtmlTappedListener, IEventInjector {
    ...
    private fun init(attrs: AttributeSet?) {
        ...
        setBackgroundColor(styles.getColor(R.styleable.AztecText_backgroundColor, ContextCompat.getColor(context, R.color.white)))
        setTextColor(styles.getColor(R.styleable.AztecText_textColor, ContextCompat.getColor(context, R.color.white)))
    ...
    public override fun onSelectionChanged(selStart: Int, selEnd: Int) {
        ...
        if (editableText.length > 1 && editableText[editableText.length - 2] == '\n') {
            return
        }
